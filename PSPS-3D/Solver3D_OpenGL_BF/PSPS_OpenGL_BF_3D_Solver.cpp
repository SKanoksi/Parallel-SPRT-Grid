...
#include "PSPS_OpenGL_BF_3D_Solver.h"

PSPS_OpenGL_BF_3D_Solver::PSPS_OpenGL_BF_3D_Solver()
{
...
bool PSPS_OpenGL_BF_3D_Solver::Init()
{
   ...
   if( !readSource("./PSPS_BF_Solver3D.comSh",comCode) ){ // The code must be found ###
      std::cout << "ERROR:: PSPS_BF_Solver3D.comSh is not found (in the same folder as this program).\n" ;
      return false;
   }
...
bool PSPS_OpenGL_BF_3D_Solver::Set()
{
...
bool PSPS_OpenGL_BF_3D_Solver::Compute()
{
    /// INITIAL
   // Open program
...
bool PSPS_OpenGL_BF_3D_Solver::Retrieve()
{
   /// Retrieve Maps ///
   // Traveltime x1
...
bool PSPS_OpenGL_BF_3D_Solver::Clear()
{
...
void PSPS_OpenGL_BF_3D_Solver::addDummyVertices()
{
   GLuint at ;
...
void PSPS_OpenGL_BF_3D_Solver::removeDummyVertices()
{
   GLuint at ;
   std::vector<TyPe> temp ;
