...
// Real main program
#include "PSPS_OpenGL_FIM_3D_Program.h"
...
int main(int argc, char* argv[])
{
   ...
   { 
       fileName = argv[1] ;
       std::cout << "************************************************\n" ;
       std::cout << "PSPS_3D_OpenGL_FIM >> Select resume project.\n" ; 
       // Run
       PSPS_OpenGL_FIM_3D_Program program ;
       program.runResumeProject(fileName, atoi(argv[2]) ); // Max loop
       std::cout << "PSPS_3D_OpenGL_FIM >> End.\n" ;
       std::cout << "************************************************\n" ;
   ...
   {  
       ...
       std::cout << "************************************************\n" ;
       std::cout << "PSPS_3D_OpenGL_FIM >> Select new project.\n" ;   
       // Run
       PSPS_OpenGL_FIM_3D_Program program ;
       ...
       std::cout << "Expect \"./Solver3D_OpenGL_FIM.exe InputFile.nc BlockX BlockY BlockZ SizeX SizeY SizeZ SourceX SourceY SourceZ MaxIteration\".\n" << std::endl;
       return 2 ;
   }
