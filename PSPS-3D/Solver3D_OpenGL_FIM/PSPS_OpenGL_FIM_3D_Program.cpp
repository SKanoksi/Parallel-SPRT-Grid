...
PSPS_OpenGL_FIM_3D_Program::PSPS_OpenGL_FIM_3D_Program()
{
	solver = new PSPS_OpenGL_FIM_3D_Solver ;
     asis = new PSPS_OpenGL_FIM_3D_Tools ;
}
...
void PSPS_OpenGL_FIM_3D_Program::runResumeProject(std::string &inFile, int maxloop)
{
   /// Welcome ///
...
void PSPS_OpenGL_FIM_3D_Program::runNewProject(std::string &inFile, std::vector<int> &param)
{
   /// Welcome ///
   const GLubyte* renderer = glGetString(GL_RENDERER);
   std::cout << "Renderer: " << renderer << " is applied.\n" ;
