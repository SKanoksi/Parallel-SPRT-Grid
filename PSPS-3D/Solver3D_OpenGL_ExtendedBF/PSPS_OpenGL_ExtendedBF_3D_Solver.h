...
class PSPS_OpenGL_ExtendedBF_3D_Solver : public PSPS_OpenGL_ExtendedBF_3D_ComShader
{
public:
    explicit PSPS_OpenGL_ExtendedBF_3D_Solver();
    ~PSPS_OpenGL_ExtendedBF_3D_Solver();
