...
int main(int argc, char* argv[])
{
   ...
   { 
       fileName = argv[1] ;
       std::cout << "************************************************\n" ;
       std::cout << "PSPS_3D_OpenGL_ExtendedBF >> Select resume project.\n" ; 
       // Run
       PSPS_OpenGL_ExtendedBF_3D_Program program ;
       program.runResumeProject(fileName, atoi(argv[2]) ); // Max loop
       std::cout << "PSPS_3D_OpenGL_ExtendedBF >> End.\n" ;
       std::cout << "************************************************\n" ;
   ...
   {  
       ...
       std::cout << "************************************************\n" ;
       std::cout << "PSPS_3D_OpenGL_ExtendedBF >> Select new project.\n" ;   
       // Run
       PSPS_OpenGL_ExtendedBF_3D_Program program ;
       ...
       std::cout << "Expect \"./Solver3D_OpenGL_ExtendedBF.exe InputFile.nc SizeX SizeY SizeZ SourceX SourceY SourceZ MaxIteration\".\n" << std::endl;
       return 2 ;
   }
