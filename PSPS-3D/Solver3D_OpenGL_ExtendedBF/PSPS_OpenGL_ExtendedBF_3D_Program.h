...
class PSPS_OpenGL_ExtendedBF_3D_Program
{
public:
   explicit PSPS_OpenGL_ExtendedBF_3D_Program();
   ~PSPS_OpenGL_ExtendedBF_3D_Program();

   void runResumeProject(std::string &inFile, int maxloop);
   void runNewProject(std::string &inFile, std::vector<int> &param);

private:
   PSPS_OpenGL_ExtendedBF_3D_Solver* solver ;
   PSPS_OpenGL_ExtendedBF_3D_Tools* asis ;
