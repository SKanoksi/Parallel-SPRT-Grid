...
#ifndef PSPS_OPENGL_3D_COMSHADER_H
#define PSPS_OPENGL_3D_COMSHADER_H
...
class PSPS_OpenGL_ExtendedBF_3D_ComShader
{
public:
    PSPS_OpenGL_ExtendedBF_3D_ComShader();
    ~PSPS_OpenGL_ExtendedBF_3D_ComShader();
...
protected:
   ...
   static std::vector<GLint> raypath ;
...
#endif // PSPS_OPENGL_3D_COMSHADER_H
