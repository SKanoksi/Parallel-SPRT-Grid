...
class PSPS_OpenGL_ExtendedBF_3D_Tools : public PSPS_OpenGL_ExtendedBF_3D_ComShader
{
public:
   explicit PSPS_OpenGL_ExtendedBF_3D_Tools();
   ~PSPS_OpenGL_ExtendedBF_3D_Tools();
