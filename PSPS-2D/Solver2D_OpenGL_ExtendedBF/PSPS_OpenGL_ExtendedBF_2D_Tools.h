...
class PSPS_OpenGL_ExtendedBF_2D_Tools : public PSPS_OpenGL_ExtendedBF_2D_ComShader
{
public:
   explicit PSPS_OpenGL_ExtendedBF_2D_Tools();
   ~PSPS_OpenGL_ExtendedBF_2D_Tools();
