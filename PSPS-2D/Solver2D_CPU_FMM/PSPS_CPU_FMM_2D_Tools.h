...
#ifndef PSPS_CPU_FMM_2D_TOOLS_H
#define PSPS_CPU_FMM_2D_TOOLS_H
...
class PSPS_CPU_FMM_2D_Tools : public PSPS_CPU_FMM_2D_ComShader
{
public:
   explicit PSPS_CPU_FMM_2D_Tools();
   ~PSPS_CPU_FMM_2D_Tools();
