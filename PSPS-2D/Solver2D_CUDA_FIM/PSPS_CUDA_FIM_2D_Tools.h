...
#ifndef PSPS_CUDA_FIM_2D_TOOLS_H
#define PSPS_CUDA_FIM_2D_TOOLS_H
...
class PSPS_CUDA_FIM_2D_Tools : public PSPS_CUDA_FIM_2D_ComShader
{
public:
   explicit PSPS_CUDA_FIM_2D_Tools();
   ~PSPS_CUDA_FIM_2D_Tools();
...
#endif // PSPS_CUDA_FIM_2D_TOOLS_H
