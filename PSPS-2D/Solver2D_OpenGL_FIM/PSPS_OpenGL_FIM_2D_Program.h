...
class PSPS_OpenGL_FIM_2D_Program
{
public:
   explicit PSPS_OpenGL_FIM_2D_Program();
   ~PSPS_OpenGL_FIM_2D_Program();

   void runResumeProject(std::string &inFile, int maxloop);
   void runNewProject(std::string &inFile, std::vector<int> &param);

private:
   PSPS_OpenGL_FIM_2D_Solver* solver ;
   PSPS_OpenGL_FIM_2D_Tools* asis ;
