...
int main(int argc, char* argv[])
{
   ...
   { 
       fileName = argv[1] ;
       std::cout << "************************************************\n" ;
       std::cout << "PSPS_2D_OpenGL_BF >> Select resume project.\n" ; 
       // Run
       PSPS_OpenGL_BF_2D_Program program ;
       program.runResumeProject(fileName, atoi(argv[2]) ); // Max loop
       std::cout << "PSPS_2D_OpenGL_BF >> End.\n" ;
       std::cout << "************************************************\n" ;
   ...
   {  
       ...
       std::cout << "************************************************\n" ;
       std::cout << "PSPS_2D_OpenGL_BF >> Select new project.\n" ;   
       // Run
       PSPS_OpenGL_BF_2D_Program program ;
       ...
       std::cout << "Expect \"./Solver2D_OpenGL_BF.exe InputFile.nc RadiusX RadiusY SizeX SizeY SourceX SourceY MaxIteration\".\n" << std::endl;
       return 2 ;
   }
