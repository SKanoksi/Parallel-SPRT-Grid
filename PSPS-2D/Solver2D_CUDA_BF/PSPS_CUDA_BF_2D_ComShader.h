...
#ifndef PSPS_CUDA_BF_2D_COMSHADER_H
#define PSPS_CUDA_BF_2D_COMSHADER_H
...
class PSPS_CUDA_BF_2D_ComShader
{
public:
    PSPS_CUDA_BF_2D_ComShader();
    ~PSPS_CUDA_BF_2D_ComShader();
...
#endif // PSPS_CUDA_BF_2D_COMSHADER_H
